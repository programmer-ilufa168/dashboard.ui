...
<template>
    ...
    <AuthenticatedLayout>
        ...
        <div class="flex flex-wrap my-2">
            <div v-for="user in users" :key="user.id" class="w-full md:w-1/6 flex flex-col bg-white dark:bg-gray-s200 dark:text-white-smooth items-center m-2 shadow rounded">
                ...
                <img class="w-32 h-32 rounded-full" src="https://www.kibrispdr.org/data/312/gambar-cewek2-cantik-4.jpg"/>
